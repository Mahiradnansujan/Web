...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/mahi2.png" alt=""> </a>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
							  ...
							  <li class="nav-item"><a href="preregistration.php" class="nav-link active">Signup</a> </li>';
							}
						else
							{
        ...
        <section class="hero bg-image" data-image-src="images/img/kgr.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Grab and Eat Our Delicious Food 😋  </h1>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="restaurant/Res_img/dishes/'.$r['img'].'"></div>
                                                <div class="content">
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="restaurant/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                <li>
                                    <a href="#"> <img src="images/pay.jpg" alt="Paypal"> </a>
                                </li>
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Rangamati Sadar-4500,chattogram</p>
                                    <h5>Phone: +8801758652809</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of Rangamati restaurants who benefit from having partnered with us.We serve organic or delicious food.</p>
                                </div>
                    </div>
                </div>
