					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,title,slogan,price,img) VALUE($id ,'".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')"; // store the submited data ino the database :images
												mysqli_query($db, $sql); 
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_menu.php?id=<?php echo $id ?>" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
