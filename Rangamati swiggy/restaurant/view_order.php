            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="res_dashboard.php?id=<?php echo $_SESSION["rs_id"] ?>"><i class="fa fa-tachometer"></i><span>Your Dashboard</span></a></li>
                        <li class="nav-label">Log</li>
                       
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Control Pannel</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="res_menu.php?id=<?php echo $_SESSION["rs_id"] ?>">All Menues</a></li>
								<li><a href="add_res_menu.php?id=<?php echo $_SESSION["rs_id"] ?>">Add Menu</a></li>
                              
                                
                            </ul>
                        </li>
						 <li> <a href="res_orders.php?id=<?php echo $_SESSION["rs_id"] ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Client Orders</span></a></li>
