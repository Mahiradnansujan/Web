...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Check Oder notifications</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="res_dashboard.php?id=<?php echo $id ?>"><i class="fa fa-tachometer"></i><span>Your Dashboard</span></a></li>
                        <li class="nav-label">Log</li>
                
						 <li> <a href="res_orders.php?id=<?php echo $id ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Clients Orders</span></a></li>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Clients Orders</h4>
                            </div>
																			...
																			?>
																						<?php																									
																							...
																							?>
																								...
																								<?php
																								echo '<a href="view_order.php?user_upd='.$rows['o_id'].'? rs_id='.$rows['rs_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
            ...
            <footer class="footer"> © Rangamati Swiggy</footer>
